...
\begin{homework}
    ...
    \begin{enumerate}
        \item Urychlený elektron vyrazí elektron z atomového obalu materiálu anody (často se jedná o wolfram).
            Do uvolněné mezery \uv{spadnou} elektrony z vyšších energetických hladin atomu nebo volné elektrony, což vede k vyzáření fotonu s ostrou hodnotou energie.
	...
	\item
		Jaká bude rychlost elektronu rozptýleného elektronu po zpětném rozptylu? Předpokládá se, že před rozptylem byl elektron v klidu.
    \item 
